"""
================================================================================
  NIFTY 50 — SMART INCREMENTAL DATA UPDATER  
...
NIFTY50_STOCKS = [
    ...
    ("TMPV.NS", "TATAMOTORSPASSENGER VEHICLES"),
...
# ==============================================================================
# CORE LOGIC: SMART UPDATE FOR ONE STOCK
# ==============================================================================

def smart_update_stock(yf_ticker, nse_symbol):
...
def run_update():
    print(f"\n{'='*80}")
    print(f"NIFTY 50 SMART DATA UPDATER")
    print(f"{'='*80}")
